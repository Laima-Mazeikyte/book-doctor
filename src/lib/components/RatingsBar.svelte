<script lang="ts">
	...
	const triggerCountsPending = $derived(countsPending || !libraryIdsReady);

	/** Rated tab: library still loading, or ids known but book rows not resolved yet. */
